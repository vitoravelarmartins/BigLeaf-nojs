...
$query = "SELECT id from exames where usuario_id='$id_user' order by id desc limit 1";

$result_exame = mysqli_query($conn, $query);

$array_db =  mysqli_fetch_array($result_exame);
$id_db_exame = $array_db['id'];
// echo ($id_db_exame);

$id_futuro = $id_db_exame + 1;
...
//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
    ...
    if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'] . $nome_final)) {
        ...
        $query = "INSERT INTO exames (usuario_id, data, descricao, arquivo_url, created_at,updated_at) 
        ...
        $query = mysqli_query($conn, "update exames set arquivo_url='$nome_final' where usuario_id='$id_futuro';");

        $_SESSION['arquivo_url_exame'] = $nome_final;
        ...
        // echo($cont_exame);
            ...
            <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/bigleaf_nodejs/php/perfil/perfiltest2/index.php'>
            <script type=\"text/javascript\">
                alert(\"exame cadastrada com Sucesso.\");
            </script>
        ";
